...
static std::vector<int> random_select(int limit, int n) {
...
static void deploy_mines(std::vector<std::vector<CellMeta>>& board, int nmines) { 
   auto selected_poses = random_select(board.size() * board.size(), nmines);
